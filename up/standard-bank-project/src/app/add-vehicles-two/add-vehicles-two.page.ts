...
@Component({
  selector: 'app-add-vehicles-two',
  templateUrl: './add-vehicles-two.page.html',
  styleUrls: ['./add-vehicles-two.page.scss'],
})
export class AddVehiclesTwoPage implements OnInit {
  //Create FormGroup
