...
@Component({
  selector: 'app-incident-scene-photos',
  templateUrl: './incident-scene-photos.page.html',
  styleUrls: ['./incident-scene-photos.page.scss'],
})
export class IncidentScenePhotosPage implements OnInit {
  userObject: any;
  token: any;
  ...
  ngOnInit() {
    this.incidentImage = JSON.parse(localStorage.getItem('incident_images'))
      ? JSON.parse(localStorage.getItem('incident_images'))
      : [];
  ...
  ionViewWillEnter() {
    console.log(this.incidentImage.length);
    // this.incidentImage = JSON.parse(localStorage.getItem('incident_images'))
    //   ? JSON.parse(localStorage.getItem('incident_images'))
    //   : [];
    localStorage.setItem('incident-photo-lenght', '' + this.incidentImage.length);
  }
  // async captureImage() {
  ...
  //         localStorage.setItem('incident-photo-lenght', '' + this.imgLength);
  //         const imgData = {
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: () => {
            ...
            this.imgLength = localStorage.getItem('incident_images');
  ...
  submitIncident() {
    ...
    formData.append('type', 'incident_scene');
    localStorage.setItem(
  ...
  getPotholeByType() {
    const id = localStorage.getItem('incident_scene')
      ? localStorage.getItem('incident_scene')
      : '';
    this.apiService.getPothole('incident_scene', this.token, id).subscribe(
      (res: any) => {
